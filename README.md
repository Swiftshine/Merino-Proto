...
> [!NOTE]
> As Merino is still a prototype, **there will not be any official releases at this time.** To download a development version compiled on a commit-by-commit basis, go to the Actions tab.
